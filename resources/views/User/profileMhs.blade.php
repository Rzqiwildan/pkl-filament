...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="bg-white shadow-lg rounded-lg p-6 w-[600px]">
        <h2 class="text-2xl font-semibold mb-4 text-center">Profile</h2>
        <div class="flex">
            <div class="flex flex-col items-center mr-6">
                <img id="profile-img" class="w-32 h-32 rounded-full object-cover" src="https://i.pinimg.com/736x/2d/9f/8d/2d9f8d4e12b1aceb0d77109f753e46cf.jpg" alt="Profile">
            ...
            <div class="flex-1">
                <div class="flex items-center justify-between mb-4">
                    <label class="text-sm font-medium w-24">NIM</label>
                    <input type="text" class="flex-1 border border-gray-300 rounded-lg p-2" value="24060122140124" placeholder="Masukkan NIM Anda" disabled>
                </div>
                <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex items-center justify-between mb-4">
                    <label class="text-sm font-medium w-24">Jurusan</label>
                    <input type="text" class="flex-1 border border-gray-300 rounded-lg p-2" placeholder="Masukkan Jurusan Anda" disabled>
                </div>
                <div class="flex items-center justify-between mb-4">
                    <label class="text-sm font-medium w-24">Universitas</label>
                    <input type="text" class="flex-1 border border-gray-300 rounded-lg p-2" placeholder="Masukkan Universitas Anda" disabled>
                </div>
                <div class="flex items-center justify-between mb-4">
