...
<body class="bg-gray-100">
    <div class="container mx-auto p-6 mt-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="border rounded-lg p-6" style="border: 1px solid #a2a2a2;">
                ...
                <form id="form-ikut-pelatihan" action="{{ route('ikut.pelatihan') }}" method="POST">
                    ...
                    <button id="registerButton" type="submit" class="{{ $isRegistered ? 'disabled' : '' }}"
        ...
        <!-- Dropdown Bagian 1 -->
        <div x-data="{ open: false }" class="mt-4 bg-gray-100 rounded-lg border" style="border: 1px solid #a2a2a2;">
