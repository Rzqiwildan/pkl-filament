    ...
    <div class="container mx-auto px-4 py-8 mt-16">
        ...
        <div class="mt-6">
            <div class="bg-white p-4 rounded-lg shadow-md mb-6">
                ...
                <form action="{{ route('teacher.storeBagian', $pelatihan->id) }}" method="POST">
                    @csrf
                    <div>
                    ...
                    <button type="submit"
                        class="bg-green-600 text-white px-4 py-2 mt-2 rounded-md hover:bg-green-700 transition">
                        Tambah Pertemuan
                    </button>
                </form>
            </div>
            @foreach ($pelatihan->bagianPelatihans as $bagian)
                <div x-data="{ open: false }" class="mb-4 bg-white rounded-lg border shadow-md">
                    ...
                    <div x-show="open" x-transition x-cloak class="px-4 py-2 space-y-2">
                        ...
                        <form action="{{ route('teacher.storeMateri', $bagian->id) }}" method="POST"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Link YouTube (Opsional)</label>
                        ...
                        <button type="button"
                            onclick="confirmDelete('{{ route('teacher.deleteBagian', $bagian->id) }}')"
